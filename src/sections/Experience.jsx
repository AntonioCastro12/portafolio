const experiences = [
  {
    ...
    role: "Desarrollador Full Stack / RCM CodeDev",
    company: "Soluciones digitales a la medida",
    description: "Diseño y desarrollo sitios web, sistemas administrativos, automatizaciones y aplicaciones personalizadas para negocios que necesitan presencia digital y procesos más eficientes.",
    technologies: ["React", "TypeScript", "Node.js", ".NET", "n8n"],
    current: true,
  },
  {
    period: "2021 - 2023",
    role: "Ingeniero Frontend",
    company: "Aplicaciones web empresariales",
    description: "Construcción de interfaces modernas, dashboards y módulos internos con enfoque en rendimiento, accesibilidad, diseño responsivo y mantenimiento a largo plazo.",
    technologies: ["React", "Angular", "Tailwind", "APIs", "Git"],
    current: false,
  },
  {
    period: "2020 - 2021",
    role: "Desarrollador Backend",
    company: "APIs y bases de datos",
  ...
  },
  {
    ...
    company: "Sitios web y herramientas para negocios",
    description: "Entrega de páginas web, formularios, catálogos, landing pages y herramientas internas para emprendedores y pequeñas empresas.",
